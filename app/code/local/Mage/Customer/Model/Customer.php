...
class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract {
    ...
    public function sendNewAccountEmail($type = 'registered', $backUrl = '', $storeId = '0', $password = null) {
         ...
         */
        $email = $this->getEmail();
        $this->setUnsubscriptionlink(Mage::getModel('newsletter/subscriber')->loadByEmail($email)->getUnsubscriptionLink());
        /*
         * End
         */
    ...
    public function sendChangedPasswordOrEmail() {
        ...
        $this->_sendEmailTemplate(self::XML_PATH_CHANGED_PASSWORD_OR_EMAIL_TEMPLATE, self::XML_PATH_CHANGED_PASSWORD_OR_EMAIL_IDENTITY, array('customer' => $this), $storeId, $this->getOldEmail());
    ...
    public function sendPasswordResetConfirmationEmail() {
         ...
         *
        $email = $this->getEmail();
        if (Mage::getModel('newsletter/subscriber')->loadByEmail($email)->getSubscriberId())
            $this->setUnsubscriptionlink(Mage::getModel('newsletter/subscriber')->loadByEmail($email)->getUnsubscriptionLink());
        /*
         * End
         */
