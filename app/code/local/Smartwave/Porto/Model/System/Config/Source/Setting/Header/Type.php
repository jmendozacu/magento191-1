...
class Smartwave_Porto_Model_System_Config_Source_Setting_Header_Type
{
    public function toOptionArray()
    {
        return array(
            ...
            array('value' => '11', 'label' => Mage::helper('porto')->__('Type 12 [CWA]')),
            array('value' => '12', 'label' => Mage::helper('porto')->__('Type 13')),
            array('value' => '13', 'label' => Mage::helper('porto')->__('Type 14 [CWOUK]')),
            array('value' => '14', 'label' => Mage::helper('porto')->__('Type 15 [CWOUS]')),
            array('value' => '15', 'label' => Mage::helper('porto')->__('Type 16 [CWNZ]')),
            array('value' => '16', 'label' => Mage::helper('porto')->__('Type 17 [Newizze Custom]'))
        );
    }
}