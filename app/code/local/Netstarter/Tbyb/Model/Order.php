...
class Netstarter_Tbyb_Model_Order extends Mage_Sales_Model_Order
{
    const XML_PATH_EMAIL_TBYB_TEMPLATE = 'curvesence/tbyb/template_new_order';
    ...
    public function queueNewOrderEmail($forceMode = false)
    {
        ...
        if ($this->getCustomerIsGuest()) {
            ...
            if ($this->_getStoreModel()->quoteHasTbybProducts($quote->getBillingAddress()))
            {
                $templateId = Mage::getStoreConfig(self::XML_PATH_EMAIL_TBYB_TEMPLATE, $storeId);
            }
            else
            {
