...
class Netstarter_Modulerewrites_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
    ...
    public function createPostAction()
    {
        ...
        try {
            ...
            $_customerDob = $this->getRequest()->getPost('dob');
            $_dob = date("d/m/Y", strtotime($_customerDob));
            $customer['dob'] = $_dob;
    ...
    public function forgotPasswordPostAction()
    {
        ...
        if ($email) {
            ...
            $this->_getSession()->unsetData('passreset_email');
            $this->_redirect('*/*/');
            return;
        } else {
