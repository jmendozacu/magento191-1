...
class Netstarter_Colors_Block_Adminhtml_Option_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct() {
        ...
        $this->_updateButton('color', 'label', Mage::helper('adminhtml')->__('Save Filter'));
