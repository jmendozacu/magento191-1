 ...
 */
class Netstarter_Colors_Block_Adminhtml_Option_Renderer_Image extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row) {
        ...
        if($data){
            $src_url = Mage::getBaseUrl('media').'color_palette/'.$data;
        ...
        $upload_block = $this->getLayout()->createBlock('adminhtml/media_uploader')
                ...
                ->setTemplate('ns_navigation/upload.phtml');
