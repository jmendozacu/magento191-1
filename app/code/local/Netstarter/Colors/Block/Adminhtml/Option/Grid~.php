 ...
 */
class Netstarter_Colors_Block_Adminhtml_Option_Grid extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{

    protected function _prepareCollection() {
        $collection = Mage::getResourceModel('catalog/product_attribute_collection')->addVisibleFilter();
        $collection->addFieldToFilter('frontend_input', array('select', 'multiselect', 'price'));
        ...
        $table = Mage::getResourceModel('ns_navigation/filter')->getMainTable();
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('position', array(
            'header' => Mage::helper('ns_navigation')->__('Attribute Position Order'),
            'sortable' => true,
            'align' => 'left',
            'index' => 'position'
        ));
