<?php
/**
 * Class that generates the international shipping rates.
 * Highly based on the flat rate default Magento shipping method.
 *
 * @category  Netstarter
 * @package   Netstarter_International
 * 
 * Class Netstarter_International_Model_Carrier_International
 */
class Netstarter_International_Model_Carrier_International
    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    protected $_code = 'netstarter_international';
    ...
    {
        return array('netstarter_international'=>$this->getConfigData('name'));
    }
}