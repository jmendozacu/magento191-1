...
/**
 * Class Netstarter_Retaildirections_Model_Resource_Synchronization
 *
 * @category  Netstarter
 * @package   Netstarter_Retaildirections
 *
 */
class Netstarter_Retaildirections_Model_Resource_Synchronization extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    protected function _construct()
    {
        ...
        $this->_init('netstarter_retaildirections/synchronization', 'event_code');
    }
     ...
     * @return string
     */
    public function getLastSuccessRun($obj)
    {
        ...
        $bind = array('event_code' => get_class($obj));
