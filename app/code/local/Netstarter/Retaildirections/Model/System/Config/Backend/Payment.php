 ...
 */
class Netstarter_Retaildirections_Model_System_Config_Backend_Payment extends Mage_Core_Model_Config_Data
{
    ...
    protected function _beforeSave() {
        ...
        if (is_array($values)) {
            ...
            foreach ($values as $groupId => $method) {
                if (!array_key_exists($method['payment_code'], $data)) {
                    $data[$method['payment_code']] = $method;
                }
            }
