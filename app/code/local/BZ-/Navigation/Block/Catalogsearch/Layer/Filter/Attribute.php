 ...
 */
class BZ_Navigation_Block_Catalogsearch_Layer_Filter_Attribute extends Mage_CatalogSearch_Block_Layer_Filter_Attribute
{
    ...
    {
        parent::__construct();
        $this->_filterModelName = 'bz_navigation/catalogsearch_layer_filter_attribute';
