...
class Plumrocket_Amp_Block_System_Config_Version extends Plumrocket_Base_Block_System_Config_Version
{
    ...
    { 
      $html = '<script type="text/javascript" src="'. $this->getSkinUrl('js/plumrocket/pramp/jscolor/jscolor.js') . '"></script>';
      return $html;
    }
