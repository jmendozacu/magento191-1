...
class N2SSPluginItemHeading extends N2SSPluginItemAbstract {
    ...
    function getTemplate($slider) {
        ...
        return "<div><h2 id='{uid}' class='{fontclass} {styleclass} {class} n2-ow' style='display: {display}; {extrastyle};'><a style='display: {display};' href='#' class='{afontclass}' onclick='return false;'>{heading}</a></h2>" . N2Html::scriptTemplate($this->getJs($slider->elementId, "{uid}")) . "</div>";
    }
